...
class CreateMcustomerDoubleCheck extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("CREATE PROCEDURE `finduniquecustomer`(IN `newrow` INT(10), IN `cnt` INT(10)) NOT DETERMINISTIC NO SQL SQL SECURITY DEFINER BEGIN
