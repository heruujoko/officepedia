...
class CreateEmployeeProc extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      DB::unprepared("CREATE PROCEDURE `autogenmemployee`(IN `newrow` INT(10)) NOT DETERMINISTIC NO SQL SQL SECURITY DEFINER BEGIN
