...
class CreateMgoodsProc extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("CREATE PROCEDURE `autogenmgoods`(IN `newrow` INT(10)) NOT DETERMINISTIC NO SQL SQL SECURITY DEFINER BEGIN
