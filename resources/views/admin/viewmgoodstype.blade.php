...
<div id="content">
	...
	<section id="widget-grid" class="">
		<!-- row -->
		<!-- row -->
        @if(Auth::user()->has_role('C_goodstype'))
		<div class="row">
			<!-- NEW WIDGET START -->
						...
						<div class="widget-body no-padding">
							<div id="insert-wrapper" class="form-horizontal" data-parsley-validate>
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="insert-mgoodstypename" value="{{old('mgoodstypename')}}" name="mgoodstypename" class="form-control forminput" placeholder="Nama Tipe Barang" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="insert-mgoodstyperemark" value="{{old('mgoodstyperemark')}}" name="mgoodstyperemark" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											<a id="btn-insert-reset" onclick="resetmgoodstype()" class="btn btn-default" ><i class=""></i> Reset</a>
											<button class="btn btn-primary" onclick="insertmgoodstype()"><i class="fa fa-save"></i> Simpan</button>
										</div>
									</div>
								</center>
							</br>
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input type="hidden" id="mgoodstypeid">
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Tipe Barang</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="edit-mgoodstypename" value="{{old('mgoodstypename')}}" name="mgoodstypename" class="form-control forminput" placeholder="Nama Tipe Barang" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Tipe Barang"></label>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="edit-mgoodstyperemark" value="{{old('mgoodstyperemark')}}" name="mgoodstyperemark" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-search" rel="tooltip" title="Keterangan"></label>
										</div>
									</div>
								</div>
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											<a onclick="backmgoodstype()" title="" class="btn btn-default">Batal</a>
											<button onclick="updatemgoodstype()" class="btn btn-primary" type="submit">
                  ...
                  <h2>View {{ $section }} </h2>
						    ...
						    <div class="form-horizontal">
							  ...
							  <div class="container">
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input disabled id="view-mgoodstypename" value="{{old('mgoodstypename')}}" name="mgoodstypename" class="form-control forminput" placeholder="Nama Tipe Barang" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Tipe Barang"></label>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input disabled id="view-mgoodstyperemark" value="{{old('mgoodstyperemark')}}" name="mgoodstyperemark" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-search" rel="tooltip" title="Keterangan"></label>
										</div>
									</div>
								</div>
								<center>
									<div class="row">
										<div class="col-md-12">
											...
											<button onclick="backmgoodstype()" class="btn btn-default" type="submit">
												<i class=""></i> Kembali
                      </button>
										</div>
									</center>
                    ...
                    <th data-hide="mgoodstypename"><center>Nama Kategori</center></th>
			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/mgoodstype/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mgoodstype/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mgoodstype/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/mgoodstype',
          										columns: [
                              {data: 'action', name:'action', searchable: false, orderable: false},
                              {data: 'no', no: 'no' },
                              {data: 'mgoodstypename', mgoodstypename: 'mgoodstypename'},
							  {data: 'mgoodstyperemark', mgoodstyperemark: 'mgoodstyperemark'}
          										]
									       });
...
@stop
@section('js')
<script src="{{ url('/master/mgoodstype.js') }}"></script>
@stop
