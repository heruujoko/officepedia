						...
						<div class="widget-body no-padding">
							<div id="insert-wrapper" class="form-horizontal" data-parsley-validate>
								...
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Satuan Barang</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="insert-mgoodsunitname" value="{{old('mgoodsunitname')}}" name="mgoodsunitname" class="form-control forminput" placeholder="Nama Tipe Barang" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Tipe Barang"></label>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="insert-mgoodsunitremark" value="{{old('mgoodsunitremark')}}" name="mgoodsunitremark" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											<a id="btn-insert-reset" onclick="resetmunit()" class="btn btn-default" ><i class=""></i> Reset</a>
											<button class="btn btn-primary" onclick="insertmunit()"><i class="fa fa-save"></i> Simpan</button>
										</div>
									</div>
								</center>
							</br>
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input type="hidden" id="munitid">
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="edit-mgoodsunitname" value="{{old('mgoodsunitname')}}" name="mgoodsunitname" class="form-control forminput" placeholder="Nama Tipe Barang" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Tipe Barang"></label>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="edit-mgoodsunitremark" value="{{old('mgoodsunitremark')}}" name="mgoodsunitremark" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-search" rel="tooltip" title="Keterangan"></label>
										</div>
									</div>
								</div>
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											<a onclick="backmunit()" title="" class="btn btn-default">Batal</a>
											<button onclick="updatemunit()" class="btn btn-primary" type="submit">
                  ...
                  <h2>View {{ $section }} </h2>
						  ...
						  <!-- widget edit box -->
						    ...
						    <div class="form-horizontal">
							  ...
							  <div class="container">
								...
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Tipe Barang</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input disabled id="view-mgoodsunitname" value="{{old('mgoodsunitname')}}" name="mgoodsunitname" class="form-control forminput" placeholder="Nama Tipe Barang" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Tipe Barang"></label>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input disabled id="view-mgoodsunitremark" value="{{old('mgoodsunitremark')}}" name="mgoodsunitremark" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-search" rel="tooltip" title="Keterangan"></label>
										</div>
									</div>
								</div>
								<center>
									<div class="row">
										<div class="col-md-12">
											...
											<button onclick="backmunit()" class="btn btn-default" type="submit">
												<i class=""></i> Kembali
                      </button>
										</div>
									</center>
                    ...
                    <th data-hide="mgoodstypename"><center>Nama Satuan</center></th>
										<th data-hide="mgoodstyperemark"><center>Keterangan</center></th>
									</tr>
								</thead>
								<tbody>
								</tbody>
			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/munits/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/munits/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/munits/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/munits',
          										columns: [
                              {data: 'action', name:'action', searchable: false, orderable: false},
                              {data: 'no', no: 'no' },
                              {data: 'mgoodsunitname', mgoodsunitname: 'mgoodsunitname'},
							  							{data: 'mgoodsunitremark', mgoodsunitremark: 'mgoodsunitremark'}
          										]
									       });
...
@stop
@section('js')
<script src="{{ url('/master/munits.js') }}"></script>
@stop
