	...
	<section id="widget-grid" class="">
						...
						<div class="widget-body no-padding">
							<div id="insert-wrapper" class="form-horizontal" data-parsley-validate>
								...
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Departemen</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="insert-departement_name" value="{{old('departement_name')}}" name="departement_name" class="form-control forminput" placeholder="Nama Departemen" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Departemen"></label>
										</div>
									</div>
								</div>
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											<a id="btn-insert-reset" onclick="resetmdepartement()" class="btn btn-default" ><i class=""></i> Reset</a>
											<button class="btn btn-primary" onclick="insertmdepartement()"><i class="fa fa-save"></i> Simpan</button>
										</div>
									</div>
								</center>
							</br>
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input type="hidden" id="mdepartementid">
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Departemen</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="edit-departement_name" value="{{old('departement_name')}}" name="departement_name" class="form-control forminput" placeholder="Nama Departemen" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Departemen"></label>
										</div>
									</div>
								</div>
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											<a onclick="backmdepartement()" title="" class="btn btn-default">Batal</a>
											<button onclick="updatemdepartement()" class="btn btn-primary" type="submit">
                  ...
                  <h2>View {{ $section }} </h2>
						    ...
						    <div class="form-horizontal">
							  ...
							  <div class="container">
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input disabled id="view-departement_name" value="{{old('departement_name')}}" name="departement_name" class="form-control forminput" placeholder="Nama Departemen" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Departemen"></label>
										</div>
									</div>
								</div>
								...
								<center>
									<div class="row">
										<div class="col-md-12">
											...
											<button onclick="backmdepartement()" class="btn btn-default" type="submit">
												<i class=""></i> Kembali
                      </button>
										</div>
									</center>
                    ...
                    <th class="hasinput" style="width:10%">
										...
										<th class="hasinput" style="width:9%">
											<input type="text" class="form-control" placeholder="Filter Nama Departemen" />
										</th>
                    <th class="hasinput" style="width:9%">
                    ...
                    <th data-hide="departement_name"><center>Nama Departemen</center></th>
			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/mdepartement/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mdepartement/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mdepartement/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/mdepartement',
          										columns: [
                              {data: 'action', name:'action', searchable: false, orderable: false},
                              {data: 'no', no: 'no' },
                              {data: 'departement_name', departement_name: 'departement_name'},
...
@stop
@section('js')
<script src="{{ url('/master/mdepartement.js') }}"></script>
@stop