...
<div id="content">
	...
	<section id="widget-grid" class="">
		<!-- row -->
		<!-- row -->
        @if(Auth::user()->has_role('C_brands'))
		<div class="row">
			<!-- NEW WIDGET START -->
			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorygoodsmark/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorygoodsmark/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorygoodsmark/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/mcategorygoodsmark',
          										columns: [
...
@stop
@section('js')
<script src="{{ url('/master/mgoodsmark.js') }}"></script>
@stop
