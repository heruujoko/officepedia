                      ...
                      <ul class="nav nav-tabs" style="padding-left:10px;">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Penawaran Penjualan</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvquotation" value="" name="msysinvquotation" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Order Penjualan (Performa Invoice)</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvproformainvoice" value="" name="msysinvproformainvoice" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Invoice Penjualan</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvsellinginvoice" value="" name="msysinvsellinginvoice" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Lock Harga Jual</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvlocksellingprice" value="" name="msysinvlocksellingprice" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Mengikuti Credit Limit</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvcreditlimit" value="" name="msysinvcreditlimit" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Harga Jual < HPP</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvspbelowcog" value="" name="msysinvspbelowcog" data-parsley-required-message="Field Ini Tidak Boleh Kosong" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Cetak Nota Penjualan Lebih Dari 1x</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvprintinvmorethanonce" value="" name="msysinvprintinvmorethanonce" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Cetak Surat jalan > 1 X</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvprintdomorethanonce" value="" name="msysinvprintdomorethanonce" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Cetak Order Penjualan > 1 X</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvprintordmorethanonce" value="" name="msysinvprintordmorethanonce" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Print Direct Dot Matrix</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysinvlptdirectprinting" value="" name="msysinvlptdirectprinting" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Permintaan Pembelian</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msyspurchrequest" value="" name="msyspurchrequest" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Order Pembelian</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msyspurchorder" value="" name="msyspurchorder" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Invoice Pembelian</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msyspurchinvoice" value="" name="msyspurchinvoice" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Mengikuti Credit Limit</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msyspurchcreditlimit" value="" name="msyspurchcreditlimit" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Foot Note Invoice</b> (<font color="red">*</font>) &nbsp  :</label>
                        ...
                        <div id="menu4" class="tab-pane">
                          <div class="form form-horizontal" style="margin-top:21px;">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Kas Bank Boleh Minus</b> (<font color="red">*</font>) &nbsp  :</label>
                          			<div class="col-md-9">
                                  <input id="edit-msysbankminus" value="" name="msysbankminus" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                          			</div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div id="menu5" class="tab-pane">
                          <div class="form form-horizontal" style="margin-top:21px;">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Multi Gudang</b> (<font color="red">*</font>) &nbsp  :</label>
                                <div class="col-md-9">
                                  <input id="edit-msysinventmultiwarehouse" value="" name="msysinventmultiwarehouse" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Multi Satuan Default</b> (<font color="red">*</font>) &nbsp  :</label>
                                <div class="col-md-9">
                                  <input id="edit-msysinventmultiuom" value="" name="msysinventmultiuom" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Menggunakan Nomor Serial </b> (<font color="red">*</font>) &nbsp  :</label>
                                <div class="col-md-9">
                                  <input id="edit-msysinventuseserial" value="" name="msysinventuseserial" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Stock Boleh Minus</b> (<font color="red">*</font>) &nbsp  :</label>
                                <div class="col-md-9">
                                  <input id="edit-msysinventallowminus" value="" name="msysinventallowminus" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"><b>Harga Jual Bertingkat</b> (<font color="red">*</font>) &nbsp  :</label>
                                <div class="col-md-9">
                                  <input id="edit-msysinventslabprice" value="" name="msysinventslabprice" class="nice-toggle" placeholder="Nama Perusahaan" type="checkbox">
                                </div>
                              </div>
                            </div>
                          </div>
