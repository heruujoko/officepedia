...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Home</li><li>Cabang</li><li>Data Cabang</li>
		</ol>
						...
						<div class="widget-body no-padding">
							...
							<form id="teste" class="form-horizontal" action="{{URL::to('/')}}/admin-nano/tambahcabang" method="post">
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input  value="{{old('mbranchcode')}}" name="mbranchcode" class="form-control forminput" placeholder="Kode Cabang" type="text" required @if (Session::has('autofocus')) autofocus @endif >
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="{{old('mbranchname')}}" name="mbranchname" class="form-control forminput" placeholder="Nama Cabang" type="text" required @if (Session::has('autofocus')) autofocus @endif >
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="{{old('address')}}" name="address" class="form-control forminput" placeholder="Alamat" type="text" required @if (Session::has('autofocus')) autofocus @endif >
								...
								<div  class="form-group">
									...
									<div  class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="{{old('phone')}}" name="phone" class="form-control forminput" placeholder="Telepon" type="number" required @if (Session::has('autofocus')) autofocus @endif >
											
											<label for="mgoodsgroup1" class="glyphicon glyphicon-phone-alt" rel="tooltip" title="Telepon"></label>
										
										<div style="height: 28px;">
										<h5 style="font-size: 11px;">&nbsp Example: 0542123456</h5>
										</div>
										</div>
									</div>
								</div>
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="{{old('city')}}" name="city" class="form-control forminput" placeholder="Kota" type="text" required @if (Session::has('autofocus')) autofocus @endif >
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="{{old('person_in_charge')}}" name="person_in_charge" class="form-control forminput" placeholder="Orang Yang Bertanggung Jawab" type="text" required @if (Session::has('autofocus')) autofocus @endif >
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="{{old('information')}}" name="information" class="form-control forminput" placeholder="Keterangan" type="text" @if (Session::has('autofocus')) autofocus @endif >
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div id="formedit" class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
						...
						<div class="form-horizontal"> 
							...
							<div class="container">
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="" name="mbranchcode" class="form-control" placeholder="Kode Cabang" type="text" required id="mbranchcode" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-barcode" rel="tooltip" title="Kode Cabang"></label>
										</div>
									</div>
								</div>
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="mbranchname" value="" name="mbranchname" class="form-control" placeholder="Nama Cabang" type="text" required @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-chevron-right" rel="tooltip" title="Nama Cabang"></label>
										</div>
									</div>
								</div>
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="address" value="" name="address" class="form-control" placeholder="Alamat" type="text" required @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-home" rel="tooltip" title="Alamat"></label>
										</div>
									</div>
								</div>
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											...
											<input id="phone" value="" name="phone" class="form-control" placeholder="Telepon" type="text" required @if (Session::has('autofocus')) autofocus @endif onkeypress="validate(event)"/> 
											<label for="mgoodsgroup1" class="glyphicon glyphicon-phone-alt" rel="tooltip" title="Telepon"></label>
										</div>
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="city" value="" name="city" class="form-control" placeholder="Kota" type="text" required @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-road" rel="tooltip" title="Kota"></label>
										</div>
									</div>
								</div>
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="person_in_charge" value="" name="person_in_charge" class="form-control" placeholder="Orang yang bertanggung jawab" type="text" required @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-user" rel="tooltip" title="Orang Yang Bertanggung Jawab"></label>
										</div>
									</div>
								</div>
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input value="" name="information" class="form-control" placeholder="Keterangan" type="text" id="information" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-search" rel="tooltip" title="Keterangan"></label>
										</div>
									</div>
								</div>
					...
					<div class="widget-body">
							...
							<table  id="tablembranch" class="tablecabang table table-bordered" width="100%">
			...
			$(document).ready(function(){
				...
				$('.ColVis_MasterButton').html(columnBtn);
					...
					function(isconfirm){
					if (isconfirm) {     
					swal("Terhapus!", "Data anda berhasil terhapus.", "success",
						...
						swal("Batal terhapus", "Data anda batal terhapus", "error");   
					}
					})
					}
						</script>
