...
<html lang="en-us">
	...
	<body class="">
		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white">NanoProject <span class="hidden-xs"> </span> ©2016</span>
				</div>
		...
		<script>
			if (!window.jQuery.ui) {
				document.write('{{URL::to('/')}}/<script src="js/libs/jquery-ui-1.10.3.min.js"><\/script>');
			}
		</script>
		...
		<!-- PAGE RELATED PLUGIN(S) -->
		<!-- PAGE RELATED PLUGIN(S) -->
		<script src="{{URL::to('/')}}/js/plugin/dropzone/dropzone.min.js"></script>
