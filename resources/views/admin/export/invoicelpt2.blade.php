...
<html>
    ...
    <body>
        <div class="row">
            <div class="col-md-6">
                <span class="headertext">{{ $config->msyscompname }}</span><br>
                <span class="headertext" style="margin-top: -10px">{{ $config->msyscompaddress }}</span>
            </div>
            <div class="col-md-6">
                <span class="headertext pull-right">NOTA PENJUALAN</span><br>
                <span class="headertext pull-right">No Faktur :</span>
            </div>
        </div>
        <hr>
