...
<div id="content">
	...
	<section id="widget-grid" class="">
		<!-- row -->
		<!-- row -->
        @if(Auth::user()->has_role('C_employeelevel'))
		<div class="row">
			<!-- NEW WIDGET START -->
						...
						<div class="widget-body no-padding">
							<div id="insert-wrapper" class="form-horizontal" data-parsley-validate>
								...
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Level</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="insert-category_name" value="{{old('category_name')}}" name="category_name" class="form-control forminput" placeholder="Nama Level" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
		...
		<div class="row">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input type="hidden" id="mgoodsid">
								<div style="height: 21px;" class="form-group">
									<label class="col-md-3 control-label"><b>Nama Level</b> (<font color="red">*</font>) &nbsp  :</label>
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input id="edit-category_name" value="{{old('category_name')}}" name="category_name" class="form-control forminput" placeholder="Nama Level" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Kategori"></label>
										</div>
									</div>
								</div>
                  ...
                  <h2>View {{ $section }} </h2>
						    ...
						    <div class="form-horizontal">
							  ...
							  <div class="container">
								...
								<div style="height: 21px;" class="form-group">
									...
									<div class="col-md-7">
										<div class="icon-addon addon-md">
											<input disabled id="view-category_name" value="{{old('category_name')}}" name="category_name" class="form-control forminput" placeholder="Nama Level" type="text" required data-parsley-required-message="Field Ini Tidak Boleh Kosong" @if (Session::has('autofocus')) autofocus @endif >
											<label for="mgoodsgroup1" class="glyphicon glyphicon-info-sign" rel="tooltip" title="Nama Kategori"></label>
										</div>
									</div>
								</div>
                    ...
                    <th class="hasinput" style="width:10%">
										...
										<th class="hasinput" style="width:9%">
											<input type="text" class="form-control" placeholder="Filter Nama Level" />
										</th>
                    <th class="hasinput" style="width:9%">
                    ...
                    <th data-hide="level"><center>Nama Level</center></th>
			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/memployeelevel/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/memployeelevel/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/memployeelevel/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/memployeelevel',
          										columns: [
...
@stop
@section('js')
<script src="{{ url('/master/memployeelevel.js') }}"></script>
@stop
