			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorygoods/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorygoods/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorygoods/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/mcategorygoods',
          										columns: [
...
@stop
@section('js')
<script src="{{ url('/master/mcategorygoods.js') }}"></script>
@stop