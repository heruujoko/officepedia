...
<div id="content">
	...
	<section id="widget-grid" class="">
		<!-- row -->
		<!-- row -->
        @if(Auth::user()->has_role('C_categorycustomer'))
		<div class="row">
			<!-- NEW WIDGET START -->
			                 ...
			                 table = $('.tableapi').DataTable({
                              ...
                              buttons: [ {
                                  ...
                                  },
                                  {
                                      text: 'CSV',
                                      action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorycustomer/export/csv') }}";
																			}
                                  },
                                  {
																			text: 'Excel',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorycustomer/export/excel') }}";
																			}
                                  },
                                  {
																			text: 'PDF',
																			action: function(){
																				window.location.href = "{{ url('admin-nano/mcategorycustomer/export/pdf') }}";
																			}
                                  },
                                  {
                                      extend: 'print',
                                      exportOptions: {
                                          columns: [ 1, 2, 3] //setting kolom mana yg mau di export
					       				      ...
					       				      processing: false,
										          serverSide: false,
										          ajax: '{{URL::to('/')}}/admin-api/mcategorycustomer',
          										columns: [
...
@stop
@section('js')
<script src="{{ url('/master/mcategorycustomer.js') }}"></script>
@stop
