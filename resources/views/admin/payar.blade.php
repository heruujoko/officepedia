  ...
  $(function(){
    ...
    dom: "<'dtpadding' <'row' <'clmn' > <'srch' f> <'tablerow' l> <'clear'> <'masterbutton' B> r> <'row pb' tip>>",
        ...
        },
        {
            text: 'CSV',
            action: function(){
              window.location.href = "{{ url('/admin-nano/payar/export/csv') }}"
            }
        },
        {
            text: 'Excel',
            action: function(){
              window.location.href = "{{ url('/admin-nano/payar/export/excel') }}"
            }
        },
        {
            text: 'PDF',
            action: function(){
              window.location.href = "{{ url('/admin-nano/payar/export/pdf') }}"
            }
        },
        {
            extend: 'print',
        ...
        },
        {
          ...
          columns: ':gt(1)'
                ...
                {data: 'no', no: 'no' },
								{data: 'mhpayarno', mhpayarno: 'mhpayarno' },
								{data: 'mhpayarcustomername', mhpayarcustomername: 'mhpayarcustomername' },
								{data: 'mhpayardate', mhpayardate: 'mhpayardate' },
								{data: 'mhpayarpayamount', mhpayarpayamount: 'mhpayarpayamount' },
								{data: 'outstanding', outstanding: 'outstanding' },
								{data: 'mhpayarremarks', mhpayarremarks: 'mhpayarremarks' }
                ]
              }).on('xhr.dt',function(){
