				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form data-parsley-validate method="post" action="{{ url('signup') }}" id="form-register" class="smart-form client-form">
								<header>
									Registrasi
								</header>
								...
								<fieldset>
									<section>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" name="name" placeholder="Nama" required data-parsley-required-message="Filed ini tidak boleh kosong">
											<b class="tooltip tooltip-bottom-right">Nama anda</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-envelope"></i>
											<input type="email" name="email" placeholder="Alamat Email" required data-parsley-required-message="Filed ini tidak boleh kosong" data-parsley-type="email" data-parsley-type-message="Filed ini harus berisi email valid">
											<b class="tooltip tooltip-bottom-right">Email</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" name="password" placeholder="Password" id="password" required data-parsley-required-message="Filed ini tidak boleh kosong">
											<b class="tooltip tooltip-bottom-right">Don't forget your password</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" name="passwordConfirm" placeholder="Confirm password" required data-parsley-required-message="Filed ini tidak boleh kosong" data-parsley-equalto="#password" data-parsley-equalto-message="Filed ini harus sama dengan field password">
											<b class="tooltip tooltip-bottom-right">Don't forget your password</b> </label>
									</section>
								</fieldset>
								<footer>
