...
<script>
    ...
    methods: {
        ...
        saveInvoice(){
            ...
            let invoice_data = {
              mhpurchasequotationdeliveryno: this.invoice_do,
              mhpurchasequotationorderyno: this.invoice_order,
              mhpurchasequotationdate: this.invoice_date,
              mhpurchasequotationduedate: this.invoice_due_date,
              mhpurchasequotationsubtotal: this.invoice_subtotal,
              mhpurchasequotationdiscounttotal: this.invoice_disc,
              mhpurchasequotationtaxtotal: this.invoice_tax,
              goods: this.invoice_goods,
              mhpurchasequotationsupplierid: this.selected_supplier.msupplierid,
              mhpurchasequotationsuppliername: this.selected_supplier.msuppliername,
              type: this.invoice_type,
              no: this.invoice_no,
              autogen: this.invoice_auto
            }
            console.log(invoice_data);
            Axios.post('/admin-api/purchasequotation',invoice_data)
            .then((res) => {
              if(this.mode == 'edit'){
                  $('#edit_loading_modal').modal('toggle');
              } else {
