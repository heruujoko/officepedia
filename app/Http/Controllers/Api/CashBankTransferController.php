    ...
    public function store(Request $request){
        try{
            ...
            foreach($request->to_accounts as $to_acc){
                      MJournal::record_journal("","Transfer",$to_acc['mcoacode'],$to_acc['amount'],0,$to_acc['description'],"","",$request->date,$to_acc['department']);
            ...
            MJournal::record_journal("","Transfer",$request->from_account['mcoacode'],0,$total_K,"","","",$request->date);
            MJournal::add_prefix();
