...
class SalesquotationController extends Controller
{
    public function index(){
        ...
        return '<center><div class="button">
            ...
            <input type="hidden" name="id" value="@{{ task.id }}"> <font style="font-family: arial;">Hapus </font></a>  <a class="btn btn-default btn-xs dropdown-toggle" onclick="print2(\''.$quotation->mhsalesquotationno.'\')"> <font style="">Print</font></a>    </div></center>';
